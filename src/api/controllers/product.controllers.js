import { deleteProduct, insertProduct, selectAllProducts, selectProductwhereId, updateProduct } from "../models/product.models.js";
...
export const getProductbyId = async(req, res) =>{
    ...
    try{
        ...
        const [rows] = await selectProductwhereId(id);
...
export const createProduct = async(req, res) => {
    try {
        ...
        let [rows] = await insertProduct(name, image, category, price);
...
export const modifyProduct = async (req, res) => {
    try {
        ...
        let [result] = await updateProduct(name, image, price, category, id);
        console.log(result);
